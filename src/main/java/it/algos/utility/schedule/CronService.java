...
public class CronService {
    ...
    // Definizione della classe interna per l'eccezione
    public static class CronValidationException extends Exception {
    ...
    public String info(String expression) {
        try {
            return descriviCron(expression);
    ...
    public String descriviCron(String expression) throws CronValidationException {
    ...
    private boolean isEveryMinute(String seconds, String minutes, String hours,
    ...
    private boolean isDailyExecution(String seconds, String minutes, String hours,
                                     String dayOfMonth, String month, String dayOfWeek) {
    ...
    private String formatDailyExecution(String hours, String minutes) {
        int hoursVal = Integer.parseInt(hours);
        int minutesVal = Integer.parseInt(minutes);
    ...
    private void validateDayOfWeek(String value) throws CronValidationException {
    ...
    private void validateDayPart(String day) throws CronValidationException {
    ...
    private void validaMese(String mese) throws CronValidationException {
        if (!mese.equals("*")) {
            try {
