...
public class PreferenzaForm extends CrudForm {
    ...
    public PreferenzaForm() {
        super();
    }

    //--new entityBean and update existing entityBean
    public PreferenzaForm(final CrudList parentCrudList, AbstractEntity entityBean, CrudOperation operation) {
    ...
    protected void fixBottom() {
        ...
        delete.setTooltipText("Cancella questo elemento");
        ...
        annulla.setTooltipText("Annulla e ritorna senza nessuna modifica");
        ...
        registra.setTooltipText("Registra questo elemento");
    ...
    protected void valueModelToPresentationFields() {
        PreferenzaEntity pref = (PreferenzaEntity) currentEntityBean;
